...
const AboutSection = () => {
  ...
  return (
      <section id='about' className='py-24 border-t border-[rgb(var(--border))]'>
        <Container>
          <div className='grid gap-16 items-center lg:grid-cols-2'>
            <div>
              ...
              <div className='flex flex-wrap gap-3'>
                { techStack.map((tech) => (
                    <span key={ tech } className='rounded-lg border border-indigo-300/30 px-3 py-1 text-sm text-[rgb(var(--muted))]'> { tech } </span>
                )) }
              </div>
            </div>
            ...
            <div className='relative flex justify-center'>
              ...
              {/* photo card */ }
              <div className='relative w-full max-w-sm rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--surface))] p-4'>
                <div className='overflow-hidden rounded-2xl'>
                  <img src='./me.jpg' alt='Vano' className='h-full w-full object-cover' loading='lazy' />
